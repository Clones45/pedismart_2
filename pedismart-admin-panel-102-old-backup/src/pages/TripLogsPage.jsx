...
const TripLogsPage = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case "COMPLETED_EARLY":
        return isDarkMode ? "bg-yellow-900 bg-opacity-30 border-yellow-700 text-yellow-400" : "bg-yellow-100 border-yellow-300 text-yellow-700";
      case "CANCELLED":
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="COMPLETED_EARLY">Early Stop</option>
                    ...
                    >
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          {/* THESIS: Coordinate Display */}
                          {(ride.tripLogs?.actualPickupLocation?.latitude || ride.pickup?.latitude) && (
                            <div className={`mt-2 p-2 rounded text-xs font-mono border ${isDarkMode ? 'bg-gray-900 border-gray-700 text-gray-400' : 'bg-gray-50 border-gray-200 text-gray-500'}`}>
                              <div className="flex justify-between">
                                <span>Pickup Coords:</span>
                                <span>
                                  {ride.tripLogs?.actualPickupLocation?.latitude
                                    ? `${ride.tripLogs.actualPickupLocation.latitude.toFixed(5)}, ${ride.tripLogs.actualPickupLocation.longitude.toFixed(5)}`
                                    : `${ride.pickup?.latitude.toFixed(5)}, ${ride.pickup?.longitude.toFixed(5)} (Est)`}
                                </span>
                              </div>
                              {ride.tripLogs?.actualPickupLocation && (
                                <div className="text-green-500 text-right font-bold mt-1">✔ Real Data Captured</div>
                              )}
                            </div>
                          )}
